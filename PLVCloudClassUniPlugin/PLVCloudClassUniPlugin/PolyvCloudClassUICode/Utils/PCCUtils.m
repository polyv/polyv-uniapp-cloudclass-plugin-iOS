...
#pragma mark - Image
+ (UIImage *)getChatroomImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVChatroom"];
}

+ (UIImage *)getLinkMicImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVLinkMic"];
}

+ (UIImage *)getRewardImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVReward"];
}

+ (UIImage *)getPlayerSkinImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVPlayerSkin"];
}

+ (UIImage *)getBaseMediaImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVBaseMedia"];
}

+ (UIImage *)getLiveInfoImage:(NSString *)imageName{
    return [self getImageWithImageName:imageName fromBundle:@"PLVLiveInfo"];
}

+ (UIImage *)getImageWithImageName:(NSString *)imageName fromBundle:(NSString *)bundleName{
    UIImage * img;
    BOOL bundleNameValid = bundleName && [bundleName isKindOfClass:NSString.class] && bundleName.length > 0;
    BOOL imageNameValid = imageName && [imageName isKindOfClass:NSString.class] && imageName.length > 0;
    if (bundleNameValid && imageNameValid) {
