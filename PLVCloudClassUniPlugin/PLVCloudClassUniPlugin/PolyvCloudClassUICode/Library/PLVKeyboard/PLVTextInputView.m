...
- (UIButton *)addButton:(NSString *)normalImgName selectedImgName:(NSString *)selectedImgName action:(SEL)action inView:(UIView *)view {
    ...
    if (normalImgName) {
        [btn setImage:[PLVKeyboardTool getImageWithImageName:normalImgName] forState:UIControlStateNormal];
    }
    if (selectedImgName) {
        [btn setImage:[PLVKeyboardTool getImageWithImageName:selectedImgName] forState:UIControlStateSelected];
    }
