...
@interface PLVTableViewController () <UITableViewDataSource, UITableViewDelegate, PLVChatCellProtocol>
...
//        if ([cell isKindOfClass:[PLVChatSpeakCell class]]) {// 设置 urlDelegate 之后，点击讲师消息中的链接将不会跳转外部浏览器，而是执行回调 '-nteractWithURL:'
//            PLVChatSpeakCell *speakCell = (PLVChatSpeakCell *)cell;
//            speakCell.urlDelegate = self;
//        }
        return cell;
    } else {
