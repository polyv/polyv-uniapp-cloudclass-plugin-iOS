...
- (UIButton *)backButton{
    if (!_backButton) {
        ...
        [_backButton setImage:[PCCUtils getRewardImage:@"plv_btn_reward_backBtn"] forState:UIControlStateNormal];
...
- (UIImageView *)ribbonImageView{
    if (!_ribbonImageView) {
        ...
        _ribbonImageView.image = [PCCUtils getRewardImage:@"plv_image_reward_ribbon"];
    }
